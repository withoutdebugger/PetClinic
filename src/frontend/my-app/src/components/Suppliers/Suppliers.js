...
class Suppliers extends React.Component {
    ...
    actionsFormatter = (cell, row) => <ListSuppliers id={row} />
    formatDate(cell) {
                ...
                <div>
                    ...
                    <div className="content-heading">
                        <Row className="no-gutters col-lg-12 col-md-12 col-xl-12">
                            <div className="col col-lg-9 col-md-8 col-xl-10">Proveedores
                            <small>Usted va a poder administrar los proveedores del sistema.</small></div>
                    ...
                    <Container fluid>
                        <Modal isOpen={this.state.modal} toggle={this.toggleModal}>
                            <ModalHeader toggle={this.toggleModal}>Nuevo Proveedor</ModalHeader>
                        ...
                        <Card>
                            <CardBody>
                                <Table keyField='supplierId' data={[]} columns={columns} />
                            </CardBody>
                        </Card>
...
export default connect(mapStateToProps, { getAllCountries })(Suppliers);